		...
		opts = {
			...
			dashboard = {
				...
				sections = {
					...
					{
						section = "terminal",
						cmd = "ascii-image-converter ~/tmp/dagrlx-color.png -C -c -b --dither; sleep .1",
			...
			indent = {
				enabled = true,
				chunk = {
					only_scope = true, -- Limita la detección de bloques de código solo al ámbito actual (scope)
					only_current = true, -- Aplica la indentación solo al bloque donde está el cursor actualmente
				},
			},
			input = { enabled = true },
			notifier = {
